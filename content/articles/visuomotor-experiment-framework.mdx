...
links:
  - label: Project Wiki
    href: https://github.com/shanaam/VisuomotorExperimentFramework/wiki/Creating-an-Experiment
  - label: JSON Config Tool
    href: https://github.com/shanaam/VisuomotorExperimentFramework/wiki/JSON-Configurator
---

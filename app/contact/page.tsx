...
const socials = [
  {
    ...
    description: "Best way to reach me for research collaborations or inquiries.",
    icon: (
  ...
  },
  {
    ...
    href: "https://scholar.google.com/citations?user=YYMl5-EAAAAJ&hl=en",
    description: "Publications and citation metrics.",
    icon: (
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/shanaa-modchalingam/",
  ...
  },
  {
    ...
    description: "Code, tools, and open-source projects.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="page-container">
      ...
      <div className="flex items-center gap-5 mb-10">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Shanaathanan Modchalingam</h1>
          <p className="text-sm text-gray-500">Shanaa</p>
        </div>
      </div>
      ...
      <p className="text-gray-600 max-w-xl mb-10">
        I&apos;m always happy to hear from researchers, collaborators, or anyone
        interested in sensorimotor neuroscience and VR. Feel free to reach out
